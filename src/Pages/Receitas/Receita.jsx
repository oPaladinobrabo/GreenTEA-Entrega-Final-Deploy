  ...
  return (
    ...
    <div>
        <div className="row">
            ...
            <div className="col-2">
                <Link to={"/receitas"} className="btn btn-info  align-content-center p-2">Voltar</Link>
            </div>   
        </div>
        <hr />
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-7">
                                    ...
                                    <p>
                                        ...
                                        <strong> Rendimento {receita.numPorcoes} porções</strong>
                                    </p>
                                    <p>
                                    ...
                                    <p><Link to={`/receita/editar/${receita.id}`} className="btn btn-warning" >Editar</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
