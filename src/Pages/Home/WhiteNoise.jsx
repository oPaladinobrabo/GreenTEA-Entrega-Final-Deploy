...
const WhiteNoise = () => {
    let Aquecedor = "assets/whiteNoises/Aquecedor.mp3";
let Aspirador = "assets/whiteNoises/Aspirador.mp3";
let Carro = "assets/whiteNoises/Carro.mp3";
let Cascata = "assets/whiteNoises/Cascata.mp3";
let Chuva = "assets/whiteNoises/Chuva.mp3";
let Chuveiro = "assets/whiteNoises/Chuveiro.mp3";
let Mar = "assets/whiteNoises/Mar.mp3";
let Nebulizador = "assets/whiteNoises/Nebulizador.mp3";
let Secador = "assets/whiteNoises/Secador.mp3";
let Ulterino = "assets/whiteNoises/Ulterino.mp3";
let Ventilador = "assets/whiteNoises/Ventilador.mp3";
let audio;
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w3">
                                            ...
                                            <img src="assets/icons/rain (1).png"/>
                                            <span>Chuva</span>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w4">
                                            ...
                                            <img src="assets/icons/cascata.png"/>
                                            <span>Cascata</span>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w6">
                                            ...
                                            <img src="assets/icons/chuveiro.png"/>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w9">
                                            ...
                                            <img src="assets/icons/gravida.png"/>
                                            <span>Uterino</span>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w11">
                                            ...
                                            <img src="assets/icons/car (1).png"/>
                                            <span>Carro</span>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w44">
                                            ...
                                            <img src="assets/icons/aquecedor.png"/>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w55">
                                            ...
                                            <img src="assets/icons/aspirador-de-po.png"/>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w66">
                                            ...
                                            <img src="assets/icons/secador-de-cabelo.png"/>
                                            <span>Secador</span>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w77">
                                            ...
                                            <img src="assets/icons/ventilador-de-mesa.png"/>
                                ...
                                <div className="col-12 col-sm-6 col-md-4 col-lg-3  mb-2 rounded-lg d-flex wrap justify-content-center">
                                    <div style={{width: '170', position: 'relative'}}>
                                        <label htmlFor="w88">
                                            ...
                                            <img src="assets/icons/nebulizer.png"/>
