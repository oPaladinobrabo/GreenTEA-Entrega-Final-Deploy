                    ...
                    <div className="row">
                        <div className="col-md-12 col-lg-5">
                            <Link to="/#">
                                ...
                                src="assets/media/pexels-sharon-mccutcheon-1148998.jpg" style={{maxHeight:'180'}}/>
                            </Link>
                ...
                <div className="col-sm-6 col-12 item">
                    <div className="row">
                        <div className="col-md-12 col-lg-5">
                            <Link to="/#">
                                <img className="img-fluid rounded-lg"
                                src="assets/media/pexels-sharon-mccutcheon-1148998.jpg" style={{height: '180', maxHeight: '180'}}/>
                            </Link>
                        </div>
                        <div className="col">
